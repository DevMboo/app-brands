        ...
        <nav class="flex justify-between gap-2 relative mb-3">
            <div>
                <ul class="text-gray-700 flex">
                    <li>
                        <a href="#" @click="$dispatch('show-created-group')" class="text-sm w-full flex gap-1 items-center px-4 py-2 bg-transparent hover:bg-slate-200 rounded-lg">          
                    ...
                    <li>
                        <a href="#" @click="$dispatch('show-historic-group')" class="text-sm w-full flex gap-2 px-4 py-2 bg-transparent hover:bg-slate-200 rounded-lg">
                            Histórico geral
                        </a>
                    </li>
                </ul>
