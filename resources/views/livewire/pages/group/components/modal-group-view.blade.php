        ...
        <form wire:submit="save">
            <div class="flex items-center">
                <div class="flex justify-between w-full mt-4 border-s-4 border-red-600">
                    <h1 class="ps-3 font-semibold">Grupo econômico</h1>
                    <button type="button" @click="$dispatch('dismiss-view-group')" class="bg-neutral-300 hover:bg-neutral-800 hover:text-white w-8 h-8 me-4 flex justify-center items-center rounded-full">
