<div class="fixed top-0 left-0 w-screen h-screen z-[1040] bg-[rgba(0,0,0,.5)] {{ $render ? 'block' : 'hidden' }}">
    <div class="w-full max-w-lg h-auto min-h-48 bg-white rounded-xl mx-auto my-16">
        <form wire:submit="save">
            <div class="flex items-center">
                <div class="flex justify-between w-full mt-4 border-s-4 border-purple-600">
                    <h1 class="ps-3 font-semibold">Criar nova bandeira</h1>
                    <button type="button" @click="$dispatch('dismiss-created-flag')" class="bg-neutral-300 hover:bg-neutral-800 hover:text-white w-8 h-8 me-4 flex justify-center items-center rounded-full">
            ...
            <div class="min-h-44 px-3 mt-6">
                ...
                <div class="mb-4">
                    ...
                    <select id="group_economy_id" wire:model="group_economy_id" class="bg-gray-50 border border-gray-300 h-[46px] text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
