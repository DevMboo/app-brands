<div class="h-80 relative" wire:ignore.self>
    <div class="flex justify-between">
        <h1 class="text-neutral-800 text-lg font-semibold">Atividades mais realizadas</h1>
        <div class="flex justify-end">
            <div class="relative" x-data="{ expanded: false }">
                ...
                <div x-show="expanded" @click.outside="expanded = false"
                    class="absolute top right-0 z-40 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-lg p-2">
